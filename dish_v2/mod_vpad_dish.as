...
; mtinfo+thumb area+wpad+trig(hsp3dish only) / ze-na 2025
; LRpad+2btn+trigger / ze-na 2025
;----------------------------------------------------------------
...
#deffunc hspvpad_init int _p1, int _p2, int _p3, int _p4
	...
	if (vppos&8)=0 {
	if (vppos&32)=0 {
		px1=0:px2=128:if vppos&1:px1=128:px2=0
		hspvpad_addkey vpadx+px1,vpady,16,3
		hspvpad_addkey vpadx+px2,vpady,2048,0
		hspvpad_addkey vpadx+64,vpady-64,4096,2
		hspvpad_addkey vpadx+64,vpady+64,8192,1
	}else{
		px1=16:px2=112:if vppos&1:px1=112:px2=16
		hspvpad_addkey vpadx+px1,vpady,4096,2
		hspvpad_addkey vpadx+px2,vpady,2048,0
	}
	}else{
		hspvpad_addkey vpadx,vpady,1,7
...
#deffunc hspvpad_key var _p1, int _p2
	...
	loop
	vptrg=(_p1^vppre)&_p1:vppre=_p1:_p1=vptrg|(_p1&_p2) ;トリガ処理
	vpkey=_p1
	return
